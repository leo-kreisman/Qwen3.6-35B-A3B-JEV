# SOURCE: https://arxiv.org/pdf/2602.24281
...
Ali Behrouz 1,2,† Zeman Li 1,3 Yuan Deng 1 Peilin Zhong 1 Meisam Razaviyayn 1,3 Vahab Mirrokni 1 ${}^{{}^{{}^{1}}}$${}^{{}^{{}^{2}}}$${}^{{}^{{}^{3}}}$† Correspondence: alibehrouz@google.com
...
In particular, recurrent neural networks that aim to compress the past data into their memory state, maintaining a fixed size over the entire input sequence, have regained attention in re
