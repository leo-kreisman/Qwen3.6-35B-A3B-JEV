# SOURCE: https://github.com/Lidenburg/llama.cpp
...
- Multimodal support arrived in `llama-server`: [#12898](https://github.com/ggml-org/llama.cpp/pull/12898) | [documentation](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/multimodal.md)
...
- Install `llama.cpp` using [brew, nix or winget](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/install.md)
- Run with Docker - see our [Docker documentation](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/docker.md)
- Download pre-built binaries from the [releases page](https://github.com/ggml-org/llama.cpp/releases)
- Build from source by cloning this repository - check out [our build guide](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md)
...
Instructions for adding support for new models: [HOWTO-add-model.md](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/development/HOWTO-add-model.md)
...
- Android: [llama.android](/Lidenburg/llama.cpp/blob/moe-expert-caching/examples/llama.android)
UIs
...
|---|---|
| [Metal](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#metal-build) | Apple Silicon |
| [BLAS](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#blas-build) | All |
| [BLIS](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/BLIS.md) | All |
| [SYCL](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/SYCL.md) | Intel GPU |
| [OpenVINO [In Progress]](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/OPENVINO.md) | Intel CPUs, GPUs, and NPUs |
| [MUSA](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#musa) | Moore Threads GPU |
| [CUDA](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#cuda) | Nvidia GPU |
| [HIP](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#hip) | AMD GPU |
| [ZenDNN](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#zendnn) | AMD CPU |
| [Vulkan](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#vulkan) | GPU |
| [CANN](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#cann) | Ascend NPU |
| [OpenCL](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/OPENCL.md) | Adreno GPU |
| [IBM zDNN](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/zDNN.md) | IBM Z & LinuxONE |
| [WebGPU](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md#webgpu) | All |
| [RPC](https://github.com/ggml-org/llama.cpp/tree/master/tools/rpc) | All |
| [Hexagon [In Progress]](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/snapdragon/README.md) | Snapdragon |
| [VirtGPU](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/backend/VirtGPU.md) | VirtGPU APIR |
...
- Use the [GGUF-my-LoRA space](https://huggingface.co/spaces/ggml-org/gguf-my-lora) to convert LoRA adapters to GGUF format (more info: [ggml-org#10123](https://github.com/ggml-org/llama.cpp/discussions/10123))
- Use the [GGUF-editor space](https://huggingface.co/spaces/CISCai/gguf-editor) to edit GGUF meta data in the browser (more info: [ggml-org#9268](https://github.com/ggml-org/llama.cpp/discussions/9268))
- Use the [Inference Endpoints](https://ui.endpoints.huggingface.co/) to directly host `llama.cpp` in the cloud (more info: [ggml-org#9669](https://github.com/ggml-org/llama.cpp/discussions/9669))
To learn more about model quantization, [read this documentation](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/quantize/README.md)

## [`llama-cli`](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/cli)
...
The [grammars/](/Lidenburg/llama.cpp/blob/moe-expert-caching/grammars) folder contains a handful of sample grammars. To write your own, check out the [GBNF Guide](/Lidenburg/llama.cpp/blob/moe-expert-caching/grammars/README.md).

For authoring more complex JSON grammars, check out [https://grammar.intrinsiclabs.ai/](https://grammar.intrinsiclabs.ai/)

## [`llama-server`](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/server)
...
## [`llama-perplexity`](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/perplexity)

#### A tool for measuring the [perplexity](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/perplexity/README.md) 1 (and other quality metrics) of a model over a given text.
...
## [`llama-bench`](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/llama-bench)
...
## [`llama-simple`](/Lidenburg/llama.cpp/blob/moe-expert-caching/examples/simple)
...
- Read the [CONTRIBUTING.md](/Lidenburg/llama.cpp/blob/moe-expert-caching/CONTRIBUTING.md) for more information
- Make sure to read this: [Inference at the edge](https://github.com/ggml-org/llama.cpp/discussions/205)
- A bit of backstory for those who are interested: [Changelog podcast](https://changelog.com/podcast/532)

## Other documentation

- [cli](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/cli/README.md)
- [completion](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/completion/README.md)
- [server](/Lidenburg/llama.cpp/blob/moe-expert-caching/tools/server/README.md)
- [GBNF grammars](/Lidenburg/llama.cpp/blob/moe-expert-caching/grammars/README.md)

#### Development documentation

- [How to build](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/build.md)
- [Running on Docker](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/docker.md)
- [Build on Android](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/android.md)
- [Multi-GPU usage](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/multi-gpu.md)
- [Performance troubleshooting](/Lidenburg/llama.cpp/blob/moe-expert-caching/docs/development/token_generation_performance_tips.md)
